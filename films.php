        ...
        <form class="filter" action="" method="post">
            ...
            <select name="type" id="selectType">
                <option value="Chọn thể loại..." selected>
                    <?php
                    // Lấy tất cả thể loại cho người dùng có thể lựa chọn
        ...
        <div class="row listflim">
            ...
            if (isset($_POST['find']) || isset($_GET['type'])) {
                ...
                if (!empty($_POST['type']) || !empty($_GET['type'])) {
                    // loại phim không rỗng
                    $MaTL = (!empty($_POST['type'])) ? $_POST['type'] : $_GET['type'];
                    // lấy tên thể loại được chọn hiện ra cho người dùng
                    ...
                    // lấy tất cả phim có cùng thể loại
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="cardFilm">
                                        ...
                                        <div class="cardinfo">
                                            ...
                                            <a href="details.php?MaF=' . $row2['MaF'] . '"><button class="cardbutton">Xem phim</button></a>
                                        </div>
                                    </div>
                                </div>
                            ';
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="cardFilm">
                                    ...
                                    <div class="cardinfo">
                                        ...
                                        <p class="textbody">Chi tiết</p>
                                        <a href="details.php?MaF=' . $row3['MaF'] . '"><button class="cardbutton">Xem phim</button></a>
                                    </div>
                                </div>
                            </div>
                        ';
