            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="toCenter">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="home.php" style="color: red"><b>Trang
                                    Chủ</b></a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container" style="margin-top:20px;">
        <div class="row listflim">
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                // lấy tối đa 6 phim cùng thể loại đẻ show
                ...
                // lấy tên thể loại in ra màn hình
                ...
                echo "<a href=\"films.php?type=".$row['MaTL'] . "\" class=\"watchmore\"><p>Xem thêm</p></a></>";
                echo "</div>";
                echo "<div class=\"row\">";
                while ($row1 = $stmt1->fetch(\PDO::FETCH_ASSOC)) {
                    // in các card phim ra trang chủ theo row thể loại
                    ...
                    while ($row2 = $stmt2->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<a href=\"details.php?MaF=" . $row2['MaF'] . "\"><button class=\"cardbutton\">Xem phim</button></a>";
                        echo "</div>";
                        echo "</div>";
                        echo "</div>";
                    }
