...
<body style="background: rgb(248, 249, 250)">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="toCenter">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href=<?php if (isset($userID)) echo "bookmark.php"; ?> style="color: red"><?php if (isset($userID))
    ...
    <div class="container" style="margin-top:20px;">
        <div class="row listflim">
            <?php
            // lấy mã phim người dùng yêu thích
            ...
            if ($stmt->rowCount() > 0) {
                // lấy các thông tin chi tiết về phim
                while ($row1 = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    if ($stmt1->rowCount() > 0) {
                        ...
                        echo "<b style=\"text-align:center\">Không có phim yêu thích!</b>";
                }
                // nếu người dùng chưa bookmark phim nào hiện thông báo
            } else {
                echo "<b style=\"text-align:center\">Không có phim yêu thích!</b>";
            }
            ?>
